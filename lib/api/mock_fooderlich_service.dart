...
class MockFooderlichService {
  ...
  Future<List<ExploreRecipe>> _getTodayRecipes() async {
    ...
    final dataString =
        await _loadAsset('assets/sample_data/explore_recipes.json');
  ...
  Future<List<Post>> _getFriendFeed() async {
    ...
    final dataString = await _loadAsset('assets/sample_data/friends_feed.json');
  ...
  Future<List<SimpleRecipe>> getRecipes() async {
    ...
    final dataString = await _loadAsset('assets/sample_data/recipes.json');
